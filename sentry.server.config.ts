...
// import { prismaIntegration } from "@sentry/prisma"; // Commented out - not installed
...
Sentry.init({
  ...
  // Prisma Integration (commented out - @sentry/prisma not installed)
  ...
  beforeSend(event, hint) {
    ...
    // Scrub request data (POST bodies, etc.)
