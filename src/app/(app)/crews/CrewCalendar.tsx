        ...
        renderEventChip={(event) => {
          ...
          return (
            <div className="group/chip relative">
              ...
              {/* Tooltip */}
              <div className="pointer-events-none absolute left-0 top-full z-50 mt-1 hidden w-56 rounded-xl border border-slate-200/80 bg-white p-3 shadow-xl group-hover/chip:block dark:border-white/10 dark:bg-slate-800">
