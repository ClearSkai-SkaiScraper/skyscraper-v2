...
interface SkaiAssistantPanelProps {
  leadId: string;
}
...
export function SkaiAssistantPanel({ leadId }: SkaiAssistantPanelProps) {
        ...
        {!loading && !hasAIData && !error && !isStreaming && (
          <div className="rounded-lg border border-blue-200 bg-blue-50 p-8 text-center">
            ...
            <p className="mb-4 text-sm text-blue-700">
              Run Skai Assistant to analyze this lead and get intelligent insights
            </p>
            <Button
              onClick={runAnalysis}
