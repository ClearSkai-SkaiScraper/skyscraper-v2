...
export default async function ReportsHubPage() {
  ...
  const generalTools = [
    ...
    },
    {
      ...
      desc: "Customize your report branding with logos, colors, and company details.",
      icon: BookOpen,
    ...
    },
    {
      ...
      desc: "Design polished cover pages with your logo, tagline, and brand colors.",
      icon: Image,
      color: "from-pink-500 to-pink-600",
    },
    {
      ...
      desc: "Generate Xactimate, Symbility, and carrier-specific formatted exports.",
      icon: Package,
